...
def printing_department_part2(file):
    """
    Printing Department part two
    ...
    while rolls_of_paper_removed>0 :
        rolls_of_paper_removed=0 
        for coordinate in coordinates.keys() :
            ...
            if(coordinates[coordinate] == '@' and rolls_of_paper<4):
                new_coordinates[coordinate]='x'
                rolls_of_paper_removed+=1
            
        count+=rolls_of_paper_removed
...
def main():
    ...
    print('-----------------')
    arg1 = sys.argv[1]
    print('Result => {}'.format(printing_department_part2(arg1)))
